...
const advantagesData = [
  {
    title: "30% Lower Energy Costs",
    description: "Reduces compressed air loss, optimizing system efficiency.",
  },
  {
    title: "50% Faster Installation",
    description: "Quick-connect fittings enable rapid setup and reconfiguration.",
  },
  {
    title: "Leak-Proof & Corrosion-Resistant",
    description: "High-strength aluminum construction prevents contaminants and rust buildup.",
  },
  {
    title: "Lightweight & Space-Saving",
    description: "Compact design and modular flexibility for easy integration in workspaces.",
  },
  {
    title: "Long-Term Durability",
    description: "Minimal maintenance required, ensuring low operational costs over time.",
  },
];

const Advantages = () => {
  return (
    <div className="bg-[#F9FAFB] pb-10 md:py-10 px-[calc(var(--spacing)_*_4)] sm:px-4">
