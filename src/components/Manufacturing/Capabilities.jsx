...
const Capabilities = () => {
  ...
  return (
    <section className="py-16 bg-gray-50">
      {/* Mobile padding + alignment wrapper (no change on laptop view) */}
      <div className="px-[calc(var(--spacing)*4)] md:px-0">
        <h2 className="text-3xl lg:text-3xl font-bold text-left md:text-center text-[#001f3f] mb-12">
          Capabilities
        </h2>
      </div>

      {/* Carousel Container */}
      <div className="max-w mx-auto px-[calc(var(--spacing)*4)] md:px-6 overflow-hidden">
            ...
            >
              <div className="flex flex-col h-full border border-[#E2E2E2] overflow-hidden">
                <div className="flex-1 p-4">
                  <h3 className="text-sm font-semibold text-[#001f3f] mb-2">
                    {operation.title}
                  </h3>
                  <p className="text-xs mb-10 leading-relaxed font-light text-[#000000]">
